...
select ShipCity, count(orderid) as order_cnt
from orders
where shipcountry = 'USA'
and shipcity in ('San Francisco', 'Seattle', 'Portland','Anchorage')
group by shipcity
...
CREATE TABLE  CustomerTbl
   ...
   INSERT INTO  CustomerTbl VALUES ('C001','John','Kelley','DBA'),
									 ('C002','Amelia','Cruze','DBA'),
									 ('C003','Sophia','Henry','Cashier'),
                                     ('C004','Tom','Smith','QA'),
                                     ('C005','Mia','Stark','Cahier');
...
CREATE TABLE  OrderTbl
   ...
   PRIMARY KEY (Order_ID) 
      ...
      INSERT INTO OrderTbl VALUES (1,'C001','2019-09-27','FedEx'),
										(2,'C002','2019-09-30','UPS'),
										(3,'C002','2019-08-15','UPS'),
										(4,'C005','2019-08-20','FedEx'),
										(5,'C005','2019-09-15','UPS');
